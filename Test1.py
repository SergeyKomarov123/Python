...
userName = input()
print('=' * 40)
print(userName + "," " игра заключается в угадывании числа, которое загадывает программа.")
print("Необходимо установить верхнюю границу выше которой числа загадываться не будут. Необходимо ввести число:")
print('=' * 40)
try:
    s = int(input())
except:
